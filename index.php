<html>
	...
	<div style = "width:215px; height:50px; float:right; background-color:#00D7FF; position:relative; margin-right: 60px;">
		<a href = bussiness.php style = "color:black; text-decoration:none;"><div style = "float:left; margin:auto; position:absolute; left:10px;"><p>BIZNIS</p></div></a>
		...
		<a href = "#" style = " text-decoration:none; color: white;"><div style = "width:740px; height:50px; background-color:#FF5C94; margin: 0 0 10 0;">
		...
		<div style = "width: 1054; background-color: #666666">
			<?php
				...
				$news = "SELECT date, news_type, heading, news, photo_name FROM news ORDER BY date DESC";
